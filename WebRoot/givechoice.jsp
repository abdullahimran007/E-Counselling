...
<li><a href="edit">Edit Registration Detail</a></li>
...
<li><a href="feedback.jsp">Give Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000ff"><u><font face="Goudy Stout">Give Choices</font></u></font></h3>
                 <table>
                 <s:form action="GiveCh">
                 
                 <s:textfield name="name" label="Name"></s:textfield>
                 <s:textfield name="rank" label="Rank"></s:textfield>
                 <s:select name="cid1" label="Choice1" list="mapForSelect1" headerKey="-1"headerValue="--select--"></s:select>
                 <s:select name="cid2" label="Choice1" list="mapForSelect1" headerKey="-1"headerValue="--select--"></s:select>
                 <s:select name="cid3" label="Choice1" list="mapForSelect1" headerKey="-1"headerValue="--select--"></s:select>
                 <s:select name="branch" label="Branch" list="{'Electrical','Finance','Mechanical','Civil','HR','System','Marketing'}" headerKey="-1"headerValue="--select--"></s:select>
