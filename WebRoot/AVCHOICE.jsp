...
<tr><td height="76"><a href="index.html" class="sitenametitle">e-COUNSELLING</a>
  ...
  <tr>
          ...
          <tr>
            <td height="30" bgcolor="#09938d" class="leftcolumntitle, titlebold"><span class="columntitle">AVAILABLE CHOICES<br></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
               <font color="blue"><h4>AVAILABLE CHOICE PAGE-1</h4></font>
                <s:form action="">
                <br/>
               <s:textfield name="stdid"label="Enter id"></s:textfield><br/><br/>
                 
                 <s:submit value="Choices"></s:submit>
