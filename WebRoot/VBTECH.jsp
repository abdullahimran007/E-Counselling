...
<tr><td height="76"><a href="index.html" class="sitenametitle">e-COUNSELLING</a>
  ...
  <tr>
          ...
          <tr>
            <td height="30" bgcolor="#09938d" class="leftcolumntitle, titlebold"><span class="columntitle">BTECH Colleges<br></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
             ...
             <tr><td> <s:textfield name="yearofestablishment"label="Year Of Establishment"/></td></tr>
              ...
              <tr><td><s:checkboxlist name="branch"label="Branches"list="{'IT','Comp.Sc','Electrical','Mechanical','ETC','EEE','Marine','Civil'}"/></td></tr>
