...
<li><a href="LETTER.jsp">Provisional Allotment Letter</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000ff"><u><font face="Goudy Stout">GIVE YOUR FEEDBACK</font></u></font></h3>
                 <s:form action="feedback">
                           <tr><td><s:textfield name="fsubject" label="Subject"/></td></tr>
                 <tr><td><s:textarea name="fcontent" label="Content"/></td></tr>
                 <tr><td><s:textfield name="fdate" label="Date"></s:textfield></td></tr>
                  <tr><td colspan="2" align="right"><s:submit value="Submit"/></td></tr>
                 <tr><td><font color="#098765" size=2><s:property value="msg"/></font></td></tr>
                  </s:form>
                </body> 
