...
<li><a href="feedback.jsp">Give Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3>Provisional Allotment Letter</h3>
                 ...
                 <tr><td><s:textfield name="coursename" label="Course"/></td></tr>
                 <tr><td colspan="2" align="right"><s:submit value="Print" onclick="return printing(this)"/></td></tr>
