...
<tr><td height="76"><a href="index.html" class="sitenametitle">e-COUNSELLING</a>
  ...
  <tr>
          ...
          <tr>
            <td height="30" bgcolor="#09938d" class="leftcolumntitle, titlebold"><span class="columntitle">Counselling Details<td>
          </tr>
          <tr>
...
<li><a href="feedback.jsp">Give Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <s:form action="ViewCMgt">
                 <tr><td><s:textfield name="rkno" label="Enter your rank no."/></td></tr>
                  <tr><td colspan="2" align="right"><s:submit value="View"/></td></tr>
                 <tr><td><s:textfield name="stdid" label="StudentId"/></td></tr>
                 <tr><td><s:textfield name="name" label="Student Name"/></td></tr>
                 ...
                 <tr><td colspan="2" align="right"><s:submit value="Confirm"/></td></tr>
