...
<li><a href="viewfeed"> View Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3>COLLEGE DETAILS FOR REJECTION</h3>
                 <s:form action="Rejectstudent">
                 <tr><td><s:hidden name="colid"></s:hidden></td></tr>
                <tr><td> <s:textfield name="clgname"label="College Name"/></td></tr>
                 <tr><td> <s:textfield name="collegecode"label="College Code"/><tr><td>
                 <tr><td>  <s:textfield name="university"label="College University"/><tr><td>
                  <tr><td> <s:textfield name="yearofestablishment"label="Year Of Establishment"/><tr><td>
                  <tr><td> <s:property value="msg"></s:property><tr><td>
                    <s:submit value="Reject"></s:submit>>
                 </s:form>
                </body>
