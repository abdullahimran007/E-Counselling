...
<li><a href="viewfeed"> View Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000gf"><u><font face="Goudy Stout">Provisional Allotment Letter page-1</font></u></font></h3> 
                 <s:form action="allot">
                 <tr><td><s:select name="stdid" label="Select RegistrationId" list="mapForSelect" headerKey="-1" headerValue="_ _Select_ _"/></td></tr>
          ...
          <tr>
            <td align="center" class="txt_copyright" style="padding:3px 10px 10px 10px;">Designed by <font color="blue">RAJASHREE</font>, Thanks to <font color="blue">InterFace Software</font><br></td>
  </tr>
        </table>
</td>
      </tr>
