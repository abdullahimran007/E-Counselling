          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3>View FeedBack</h3>
                 <s:form action="">
                <tr><td><s:textfield name="name" label="Student Name" readonly="true"/></td></tr>
                 <tr><td><s:textfield name="fsubject" label="Subject" readonly="true"/></td></tr>
                 <tr><td><s:textfield name="fcontent" label="Content" readonly="true"/></td></tr>
