...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@ taglib uri="/struts-tags" prefix="s" %>
<html><head><title>Viziora</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="main.css" rel="stylesheet" type="text/css">
</head><body bgcolor="#E9F2F9">
<table width="769" border="0" align="center" cellpadding="0" cellspacing="0" height="734">
...
<li><a href="viewfeed"> View Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
               <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000ff"><u><font face="Goudy Stout">APPROVE STUDENT PAGE-2</font></u></font></h3>
                 >
                  <s:form action="ApproveStudent">
                  <s:hidden name="stdid"></s:hidden>
                 ...
                 <tr><td colspan="2" align="right"><s:submit value="Approve"/></td></tr>
