...
<li><a href="feedback.jsp">Give Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000ff"><u><font face="Goudy Stout">CHANGE PASSWORD</font></u></font></h3>
                 
                  <s:form action="changepwd">
                <tr><td><s:textfield name="password" label="Enter your Old Password"/></td></tr>
                <tr><td><s:password name="chngp" label="Enter New Password"/></td></tr>
                <tr><td><s:password name="chngpp" label="Confirm Password"/></td></tr>
