...
function validatemca(from)
{
 ...
 if(cname.length==0)
  ...
  var cweb=from.web.value;
  if(cweb.length==0)
  {
   alert("College web should be given");
   from.web.focus();
   return false;
  }
  ...
  if(desc.length==0)
  {
   alert("Provide the College description ");
...
<tr><td height="76"><a href="index.html" class="sitenametitle">e-COUNSELLING</a>
  ...
  <tr>
          ...
          <tr>
            <td height="30" bgcolor="#09938d" class="leftcolumntitle, titlebold"><span class="columntitle">MCA Registration</span></td>
          </tr>
          <tr>
...
<body>
                ...
                <li><font size="2"><a href="MBA Regd.jsp">MCA Registration</a></font></li><br/><br/><br/>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                <h3 ><font color="#009867" size=3>MCA COLLEGE REGISTRATION PAGE</font></h3>
                 
                <s:form action="McaReg" onsubmit="return validatemca(this)">
