...
<li><a href="viewfeed"> View Feedback</a></li>
          ...
          <tr>
            <td><img src="images/leftbarbtm.gif" width="216" height="12"></td>
                ...
                <body>
                 <h3 align="center" style="background-color: rgb(255, 128, 255);"><font color="#0000ff"><u><font face="Goudy Stout">APPROVE STUDENT PAGE-1</font></u></font></h3>
                 
                 <s:form action="SearchAction">
                 <tr><td><s:select name="stdid" label="Select Candidate Name" list="mapForSelect" headerKey="-1" headerValue="--Select--"/></td></tr>
